            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
              <div className="h-100">
                ...
                <p style={{ textAlign: "justify" }}>
                  At APEX, we specialize in providing high-quality construction
                  and renovation services for commercial, residential, and
                  industrial sectors. With a commitment to excellence, we
                  deliver tailored solutions that meet the unique needs of each
                  client. Whether you're looking to build from the ground up,
                  renovate an existing space, or transform your property into
                  something new, our team is here to turn your vision into
                  reality.
                </p>
                <p className="mb-4" style={{ textAlign: "justify" }}>
                  Our expertise spans across a wide range of construction
                  projects, ensuring that every project is completed on time,
                  and to the highest standards. From residential homes to
                  large-scale industrial facilities, we pride ourselves on our
                  integrity, craftsmanship, and dedication to customer
                  satisfaction.
                </p>
